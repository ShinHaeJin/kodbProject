var s,app={settings:{fadeSlides:!1,coloursSet:!1,animationTimeDelay:350,videoFadeInWait:2500,textFadeSpeed:2e3},
		init:function(){
			...
			this.animateSlides(),
			this.mailChimpAjax(),
			this.settingOptions()},bindUiActions:function(){
				$(".take-a-look").on("click",function(){
					$(".onepage-pagination li:nth-child(2)").children().trigger("click")})},initalizers:function(){
						$(".slide").css("opacity",1),$(".main").onepage_scroll({sectionContainer:"section"}),setTimeout(function(){$("#big-video-wrap").show().animate({opacity:1})},s.videoFadeInWait),$(".demo1 .rotate").textrotator({animation:"fade",speed:s.textFadeSpeed})},bigVideo:function(){var a=new $.BigVideo({useFlashForFirefox:!1});a.init(),Modernizr.touch?a.show("img/background.jpg"):a.show("video/surf.mp4",{ambient:!0,doLoop:!0,altSource:"video/surf.ogv"})},editNavigation:function(){$(".onepage-pagination").addClass("animated fadeInRight delay-3"),$(".onepage-pagination").children().each(function(){switch($(this).children().data("index")){case 1:$(this).children().append("<i class='entypo-home'></i>");break;case 2:$(this).children().append("<i class='entypo-dot'></i>");break;case 3:$(this).children().append("<i class='entypo-dot-2'></i>");break;case 4:$(this).children().append("<i class='entypo-dot-3'></i>");break;case 5:$(this).children().append("<i class='entypo-mail'></i>")}})},
						
animateSlides:function(){
	setInterval(function(){
		$("body").hasClass("viewing-page-2")&&($(".slide-1-title").removeClass("hide").addClass("animated fadeInRight delay-1"),
		...
		1==s.fadeSlides&&$(".slide-1").css("background-color","#1ABC9C")),
		$("body").hasClass("viewing-page-3")&&($(".iphone-2").removeClass("hide").addClass("animated fadeInDown delay-1"),
		...
		$(".icon span").css("color","#fff"),1==s.fadeSlides&&$(".slide-2").css("background-color","#34495e")),
		$("body").hasClass("viewing-page-4")&&($(".slide-3-title").removeClass("hide").addClass("animated fadeInLeft delay-1"),
		...
		$(".icon span").css("color","#333"),s.fadeSlides===!0&&$(".slide-3").css("background","#f1c40f")),
		/*$("body").hasClass("viewing-page-5")&&$(".icon span").css("color","#fff"),1==s.fadeSlides&&0==s.coloursSet&&($(".slide-1").css("background","#e74c3c"),
		$(".slide-2").css("background","#1ABC9C"),$(".slide-3").css("background","#34495e"),s.coloursSet=!0)*/
		$("body").hasClass("viewing-page-5")&&($(".slide-3-title").removeClass("hide").addClass("animated fadeInLeft delay-1"),
		$(".slide-3-1").removeClass("hide").addClass("animated fadeInUp delay-2"),
		$(".slide-3-2").removeClass("hide").addClass("animated fadeInDown delay-5"),
		$(".slide-3-3").removeClass("hide").addClass("animated fadeInDown delay-6"),
		$(".slide-3-scroll").removeClass("hide").addClass("animated fadeInDown delay-12"),
		$(".icon span").css("color","#333"),s.fadeSlides===!0&&$(".slide-3").css("background","#f1c40f"))
