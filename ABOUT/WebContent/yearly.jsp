  ...
  <footer><input type="submit" value="upload" class="btn btn-small"><a href="#" class="btn btn-small js-modal-close">Close</a></footer>
	...
	<div class="header">
		<div class="content">
		  ...
		  <form id="home" action="selectAllPhoto.do" method="post">
			  <input type="hidden" name="hidden" value="1">
						...
						<c:forEach items="${requestScope.photo}" var="photo">
							<div class="media-box category1">
								<div class="media-box-image mb-open-popup">
									...
									<div class="thumbnail-overlay" onclick="location.href='uploadSuccess.jsp';">
