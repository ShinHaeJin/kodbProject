...
<svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="100%">
  ...
  <text x="50%" text-anchor="middle" y="50%" dy="0.4em" fill="url(#pattern)" font-family="sonos-logoregular" font-size="30vh">about Time</text>
  ...
  <defs>  
    ...
    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0">
      ...
      <stop offset="75%" style="stop-color:#ffcc00;"/>
