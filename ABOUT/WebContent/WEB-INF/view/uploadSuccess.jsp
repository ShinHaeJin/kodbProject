...
<!--  data-columns="2" -->
	  ...
	  <%--   <c:if test="${requestScope.hidden eq '1' }"> --%> 
 		   <c:forEach items="${requestScope.allPhoto}" var="allPhoto">
		         <div class="media-box image">
		            <div class="media-box-image">
		                <div data-width="320" data-height="200"><img src="${allPhoto.pPath}"/></div>
		                <div data-popup="${allPhoto.pPath}" title="Dolor sit amet"></div>
		            ...
		            <div class="media-box-content">
		                <div class="media-box-title"> ${allPhoto.pComment}</div>
		                <div class="media-box-date">${allPhoto.pYear}-${allPhoto.pMonth}-${allPhoto.pDay}</div>
		            	<div class="media-box-text">
		                    <% int i = 0; %>
			                <c:forEach items="${requestScope.hash}" var="hash">
			                <% request.setAttribute("i", i); %>
			                <a href="search.do?hash=${hash}" name="hash<%=request.getAttribute("i")%>" id="hash<%=request.getAttribute("i")%>">${hash}</a> 
			            	<% i++; %>
			            	</c:forEach>
		            	</div>
		            </div>
		...
		<%-- 	<video controls width="400" height="400" autoplay>
		  ...
		  <c:forEach items="${requestScope.allVideo}" var="allVideo">
			<div class="media-box video">
		            <div class="media-box-image">
		                <div data-type="iframe" data-width="240" data-height="168" data-thumbnail="${allVideo.vPath}"><iframe src="${allVideo.vPath}" width="100%" height="100%"  frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen autoplay="false"></iframe></div>
						<div data-type="iframe" data-popup="${allVideo.vPath}" title="Psico dell consecteture"></div>
		            ...
		            <div class="media-box-content">
		                <div class="media-box-title"> ${allVideo.vComment}</div>
		                <div class="media-box-date">${allVideo.vYear}-${allVideo.vMonth}-${allVideo.vDay}</div>
		           		 <div class="media-box-text">
		                    <% int i = 0; %>
			                <c:forEach items="${requestScope.hash}" var="hash">
			                <% request.setAttribute("i", i); %>
